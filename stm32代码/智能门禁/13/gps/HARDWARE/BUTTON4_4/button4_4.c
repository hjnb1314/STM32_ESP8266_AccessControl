...
int Button4_4_Scan(void)
{
        ...
        if(key[0][0]==1)return 4;
        else if(key[0][1]==1)return 8;
        else if(key[0][2]==1)return 12;
        else if(key[0][3]==1)return 16;
        else if(key[1][0]==1)return 3;
        else if(key[1][1]==1)return 7;
        else if(key[1][2]==1)return 11;
        else if(key[1][3]==1)return 15;
        else if(key[2][0]==1)return 2;
        else if(key[2][1]==1)return 6;
        else if(key[2][2]==1)return 10;
        else if(key[2][3]==1)return 14;
        else if(key[3][0]==1)return 1;
        else if(key[3][1]==1)return 5;
        else if(key[3][2]==1)return 9;
        else if(key[3][3]==1)return 13;
